...
import com.flash.framework.dynamic.datasource.autoconfigure.druid.DruidSlf4jConfig;
import com.flash.framework.dynamic.datasource.autoconfigure.druid.DruidWallConfigUtil;
...
public class DruidDataSourceCreator {
    ...
    public DataSource createDataSource(DataSourceConfigure dataSourceProperty) {
        ...
        try {
            ...
            throw new DynamicDataSourceException("[Dynamic DataSource] DataSource Druid create failed", e);
        }
        return dataSource;
    }
}
